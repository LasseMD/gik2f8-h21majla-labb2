/* Import av nodejs inbyggda modul för att hantera http-förfrågningar. 
Vi använder i slutänden express till att utföra dessa saker, men de går att göra utan det externa paketet express.  */
...
(objekt som representerar HTTP-förfrågan) och res (objekt som representerar HTTP-svar) */
  /* HTTP-modulen innehåller en rad olika egenskaper, såsom t.ex. methods. Console.log nedan skulle 
  skriva ut de HTTP-metoder som finns, såsom t.ex. GET, POST, PUT, PATCH och DELETE. */
